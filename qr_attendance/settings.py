...
ALLOWED_HOSTS = [".onrender.com", "qrattendance-production-5d22.up.railway.app", "attendance-system-d27j.onrender.com", "ngrok-free.dev", "mooned-mom-unlikable.ngrok-free.dev", '127.0.0.1', '10.218.31.108', 'localhost', f"{server_ip}", '*' ]
